...
- The issue's own AUTHOR saying it was their mistake, a misconfiguration on their end, or that they figured it out is strong — nobody outranks the reporter on whether their problem is resolved. But check the scope: "partly my mistake, but the diff is still wrong" or a self-solve that uncovered a real provider bug keeps the issue open; score LOW then.
